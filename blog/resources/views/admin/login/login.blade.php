...
<link rel="stylesheet" type="text/css" href="/admin_template/css/login.css" media="screen">
...
<body>
    ...
    <div id="mws-login-wrapper">
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="/admin/login/loginCheck" method="post">
                    {{csrf_field()}}
    ...
    <script src="/admin_template/jui/js/jquery-ui-effects.min.js"></script>

    <!-- Plugin Scripts -->
    <script src="/admin_template/plugins/validate/jquery.validate-min.js"></script>

    <!-- Login Script -->
    <script src="/admin_template/js/core/login.js"></script>
